            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="foto_lawas" value="<?= $informasi['image'];  ?>">
                        <div class="form-group">
                            <label for="judul" class="font-weight-bold">Judul</label>
                            <input type="text" name="judul" id="judul" class="form-control" id="judul" placeholder="Judul" value="<?= $informasi['judul']; ?>">
                        ...
                        <button type="submit" name="submit" class="btn btn-primary">Edit Informasi</button>
