...
<?php if ($informasi) : ?>
    <?php foreach ($informasi as $info) : ?>
        <div class="card mb-2">
            ...
            <div class="card-body">
                <h5 class="card-title">Admin Menulis Ini &nbsp; <span class="text-muted" style="font-size: 15px;">Pada</span> </h5>
                <div class="card-text">
                    <?= $info['diskusi']; ?>
                </div>
                <hr>
                <i class="bi bi-hand-thumbs-up-fill"></i>
                <a href="<?= base_url('Diskusi/balasan/'); ?>" class="text-decoration-none ">
                    Suka
                </a>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<?php if ($diskusi) : ?>
    ...
    <?php foreach ($diskusi as $ds) : ?>
        ...
        <div class="card mb-2">
            ...
            <div class="card-body">
                <h5 class="card-title"><?= $user['name']; ?> Menulis Ini &nbsp; <span class="text-muted" style="font-size: 15px;">Pada <?= date('h:i d F Y', $ds['tanggal']); ?></span> </h5>
